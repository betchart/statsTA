...
set arrow 1 from dqq_best,-1.5 to dqq_best,-2 head filled 
set arrow 2 from dqq_best+dqq_pll05,-1.5 to dqq_best+dqq_pll05,-2 head lt 2
set arrow 3 from dqq_best-dqq_pll05,-1.5 to dqq_best-dqq_pll05,-2 head lt 2
...
plot [] [-2:6]\
    ...
    'dqq_scan.txt' using 1:($2+6792851.8620) w lines ls 0 notitle '-LL_{min}'
