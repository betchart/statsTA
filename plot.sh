...
plot [-0.03:0.03] [-0.01:0.01] \
    ...
    '' u 9:10 w lines lt 1 lw 3 lc 7 notitle, \
...
plot [-0.03:0.03] [-0.01:0.01] \
    ...
    '' u 7:8 w lines lt 1 lc 7 notitle, \
    '' u 9:10 w lines lt 1 lw 3 lc 5 notitle, \
    (x+ep >= qq && x <= qg + qq ? qq + qg - x : 1/0) lc 2 lt 2 notitle, \
    "<echo '0.003953110899140473 0.0021230524809500123'" w points ls 1 lc 2 ps 3 lw 4 title 'POWHEG CT10'
...
plot [-0.03:0.03] [-0.01:0.01] \
    ...
    '' u 7:8 w lines lt 1 lc 7 notitle, \
    '' u 9:10 w lines lt 1 lw 3 lc 3 notitle, \
    (x+ep >= qq && x <= qg + qq ? qq + qg - x : 1/0) lc 2 lt 2 notitle, \
    "<echo '0.003953110899140473 0.0021230524809500123'" w points ls 1 lc 2 ps 3 lw 4 title 'POWHEG CT10'
...
plot [-0.03:0.03] [-0.01:0.01] \
    ...
    '' u 7:8 w lines lt 1 lc 7 notitle, \
    '' u 9:10 w lines lt 1 lw 3 lc 1 notitle, \
    (x+ep >= qq && x <= qg + qq ? qq + qg - x : 1/0) lc 2 lt 2 notitle, \
    "<echo '0.003953110899140473 0.0021230524809500123'" w points ls 1 lc 2 ps 3 lw 4 title 'POWHEG CT10'
...
plot [-0.03:0.03] [-0.01:0.01] \
    ...
    '' u 7:8 w lines lt 1 lc 7 notitle, \
    '' u 9:10 w lines lt 1 lw 3 lc 4 notitle, \
    (x+ep >= qq && x <= qg + qq ? qq + qg - x : 1/0) lc 2 lt 2 notitle, \
    "<echo '0.003953110899140473 0.0021230524809500123'" w points ls 1 lc 2 ps 3 lw 4 title 'POWHEG CT10'
